...
export default function SensorCard() {
    ...
    return <div className="w-full lg:w-1/2 2xl:w-1/3">
        <div className="px-8 pb-8" onClick={() => {
            ...
            <div className="bg-emerald-600 text-white px-4 py-4 rounded-lg min-h-32">
                <div className="flow-root">
                    ...
                    <p className="float-right">{temperature.minutesAgo === 0 ? 'Just now' : temperature.minutesAgo < 60 ? temperature.minutesAgo + ' minutes ago' : ''}</p>
                </div>
                {isLoading && <p>Loading...</p>}
                {!isLoading && <div>
                    <p className="text-xl">Current temperature: {temperature.temperature}°C</p>
